...
func (m *ConcreteAccount) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ConcreteAccount.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *ConcreteAccount) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConcreteAccount.Merge(dst, src)
}
func (m *ConcreteAccount) XXX_Size() int {
	return m.Size()
}
func (m *ConcreteAccount) XXX_DiscardUnknown() {
	xxx_messageInfo_ConcreteAccount.DiscardUnknown(m)
}

var xxx_messageInfo_ConcreteAccount proto.InternalMessageInfo
